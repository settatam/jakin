...
<!-- Content Slider -->
    ...
    <div class="promo-box style3">
    	<div class="large-8 columns"><h3 style="color: #000">Do you want to make a donation?</h3><p>Help someone in your community have a better life today. Making a donation is as easy as clicking the donation button! </p></div>
        <div class=" large-4 columns">
        <div style="padding-top: 20px;">
        <a href="#" class="button large radius success" style="width: 100%">Donate Now!</a>
        </div>
        </div> 
    </div>
    </div>
