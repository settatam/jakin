...
<? include 'header.php'; ?>
<? $y = mysql_query("SELECT * FROM posts WHERE post_id = $page_id LIMIT 1"); 
...
<?  ?>
    <div class="container white" style="padding:0">
      ...
      <? include 'leftl.php' ?>
       ...
       <? $n = mysql_num_rows($y); 
	   if($n < 1) { ?>
	     <p>This article is no longer available. Please try again later</p>
	   <? } else {
