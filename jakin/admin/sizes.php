...
if($_POST['subcat']) {
	...
	$q = mysql_query("INSERT INTO sizes (sizes) VALUES ('$title')");
}
...
<div class="row">
 ...
 <?
  $q = mysql_query("SELECT *FROM sizes");
  $n = mysql_num_rows($q);
  if($n < 1) {?>
...
<? } ?>
  ...
  <div class="large-12 columns"> <h4>Add A New Size</h4></div>
  <hr>
  <div class="large-12 columns">
  <div class="row">
