	...
	new AjaxUpload($('#vpb_upload_button'), 
	{
		...
		onComplete: function(file, response)
		{
			if(response != "error")
			{
				...
				$('#vpb_uploads_displayer').append('<div class="large-3 columns" style="float:left" id="fileID'+response+'""><div onclick="describeFile(\''+response+'\')"><img src="uploaded_files/'+response+'.jpg"/></div><div id="vpb_remove_button'+response+'" class="vpb-smalltext">Remove File</div></div>');
