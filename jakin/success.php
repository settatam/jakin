...
<? include 'header.php'; ?>
<? $y = mysql_query("SELECT * FROM posts WHERE subcat  = '13' ORDER BY post_id DESC"); 
...
<?  ?>
    <div class="container white" style="padding:0">
      ...
      <? include 'leftl.php' ?>
       <div class="large-9 columns" style="margin-bottom: 15px;">
   		<h3 class="subheader">Success Stories</h3>
        <hr>
       ...
       <h6 style="margin-bottom: 7px;"><a href="newsdetail.php?pid=<?=$z->post_id?>"><?=stripslashes($z->page_title)?></a></h6>
	...
	<? }?>
     ...
     <?=substr(stripslashes($z->post), 0, 200)?> ..... <a class="inline" href="newsdetail.php?pid=<?=$z->post_id?>">Read More </a>
     </div>
