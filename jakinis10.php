    ...
    <div class="container white" style="padding:0">
      ...
      <? include 'leftl.php' ?>
       <div class="large-9 columns" style="margin-bottom: 15px;">
   		<h3 class="subheader">Jakin is 11</h3>
        <hr>
        <img src="img/subimage.jpg"/>
        <hr>
        <p>Dearest,</p>
        <p>Just like a mustard seed, the vision of JAKIN started on October 12th 2003, today it has grown into a massive tree providing succor to vulnerable groups in Nigeria and across Africa. We couldn&rsquo;t have attained this height without the commitment, love and support of our inestimable staff, volunteers, Directors and Partners. <br>
          We appreciate you all.<br>
          As we celebrate this new year, we look forward to greater exploits as we continue in our service to God and humanity.<br>
          HAPPY ANNIVERSARY.<br>
          </p>
        <p>Warm Regards,<br>
         </p>
        <p>Olubukola Adebiyi<br>
          President/CEO</p>
        </div>
