    ...
    <div class="container white" style="padding:0">
      ...
      <? include 'leftl.php' ?>
       <div class="large-9 columns" style="margin-bottom: 15px;">
   		<h3 class="subheader">Welcome to Jakin N.G.O</h3>
        <hr>
        <img src="img/subimage.jpg"/>
        <hr>
        <p>Dear Friend,</p>
        <p>On behalf of the entire Jakin Team I welcome you to our world. Jakin N.G.O desires a world devoid of poverty and it&rsquo;s consequences. We believe solution is at hand when vulnerable groups are empowered with necessary skills or resources to fight ECONOMIC, EDUCATIONAL and HEALTH hardship on their own. There won&rsquo;t be any &ldquo;less priviledged&rdquo; if only the &ldquo;priviledged&rdquo; share their privileges. </p>
        <p>We encourage you to join us in this race to make the world a better place for all. As a team, we stand a greater chance to win.</p>
        <p>TO LOVE IS TO GIVE!</p>
        <p>Warm regards,<br>
          Olubukola Adebiyi<br>
         President/CEO</p>
       </div>
