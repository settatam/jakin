    ...
    <div class="container white" style="padding:0">
      ...
      <? include 'leftl.php' ?>
       <div class="large-9 columns" style="margin-bottom: 15px;">
        ...
        <hr>
        <h5 class="subheader">International Literacy Day</h5>
        <div style="margin-bottom: 20px;"><object width="420" height="315"><param name="movie" value="//www.youtube.com/v/hFJLiFdKnaA?hl=en_GB&amp;version=3"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="//www.youtube.com/v/hFJLiFdKnaA?hl=en_GB&amp;version=3" type="application/x-shockwave-flash" width="420" height="315" allowscriptaccess="always" allowfullscreen="true"></embed></object></div>
        <h5 class="subheader">Empowering the Nigerian Child</h5>
        <div><object width="420" height="315"><param name="movie" value="//www.youtube.com/v/Ih1Bh8ldDUE?version=3&amp;hl=en_GB"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="//www.youtube.com/v/Ih1Bh8ldDUE?version=3&amp;hl=en_GB" type="application/x-shockwave-flash" width="420" height="315" allowscriptaccess="always" allowfullscreen="true"></embed></object></div>
       </div>
	</div>
