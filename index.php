    ...
    <div class="container whiter">
	  <div class="row">
       ...
       <div class="full">
        ...
        <div class="" style="font-size:11px;"><?=$g->page_title?></div></li>
        </ul>
        </div>
        <div class="large-7 columns">
        <h3 class="dark">Quick View of Things We Do ...</h3>
        <p class="lead dark">Jakin N.G.O regularly executes projects. Our projects may be Jakin Initiated or externally (donor) funded. <a href="featured.php">View All</a></p>
        <?
        ...
        <? while($h = mysql_fetch_object($k)){ ?>
         ...
         <ul class="clearing-thumbs clearing-feature" data-clearing>
              ...
              <div class="" style="width: 100%; font-size: 11px;"><?=$h->page_title?></div></li>
         </ul>
         </div>
         </div>
         <? } ?>
    ...
    <div class="container whites">
		...
		<? }?>
			...
			<p><a href="pledge.php?pageid=Pledge-Form" class="button success">Fill A Pledge Form Now</a>
   			<br /><a href="donate.php" class="button secondary">Make an Online Donation &rarr;</a><br />
            <a href="http://jakinministry.org/support.php?pageid=Donate-Now" class="button secondary">Bank Account Details &rarr;</a></p>
