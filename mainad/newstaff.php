                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-content controls">
                                    ...
                                    <div class="row-form">
                                        <div class="col-md-3"><strong>Staff Name</strong></div>
                                        <div class="col-md-9"><input type="text" class="form-control" name="title" placeholder="Enter the name of the Staff"/></div>
                                    </div>
                                    ...
                                    <div class="row-form">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" id="cat" name="category">
                                              ...
                                              <option value="4">MD/CEO</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row-form">
                                      <div class="col-md-3"><strong>Staff Picture</strong></div>
                                        <div class="col-md-9">
                                     ...
                                     <div class="row-form">
                                        ...
                                        <div class="col-md-9"><input type="submit" class="success" value="Submit Staff" name="submit"/><input name="ps" type="hidden" value="<?=$post_session?>" /></div>
                                    </div>
